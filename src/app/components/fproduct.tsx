  ...
  return (
    <div className="w-full flex justify-center items-center mt-10 mb-1">
      <div className="sm:w-full md:w-[80%] border-neutral-100 pb-10">
        ...
        {/* Product Grid */}
        <div className="flex flex-col sm:flex-row md:flex-row lg:flex-row sm:justify-center md:justify-between mt-5 sm:flex-wrap lg:flex-nowrap gap-5 sm:gap-8">
          
          {/* Product 1 */}
          <div className="group shadow-2xl items-center border-solid border-2 rounded-md sm:w-[270px] md:w-[270px] lg:w-[270px] h-[361px] flex flex-col gap-y-5 justify-center item-center cursor-pointer relative bg-[#F6F7FB]">
          ...
          <div className="group shadow-2xl items-center border-solid border-2 rounded-md sm:w-[270px] md:w-[270px] lg:w-[270px] h-[361px] flex flex-col gap-y-5 justify-center item-center cursor-pointer relative bg-[#F6F7FB]">
            ...
            <div className="flex flex-col justify-center items-center text-white w-full h-full bg-[#2F1AC4] py-2">
              <p className="font-medium text-center">Cantilever Chair</p>
              <p className="text-sm">Code - C123456</p>
