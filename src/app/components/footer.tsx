  ...
  return (
    <div>
      <footer className="text-gray-600 body-font bg-[#EEEFFB]">
        ...
        <div className="bg-[#E7E4F8] w-full h-[53px]">
          <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
            ...
            <div className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
              <Link href="https://facebook.com">
                <FaFacebook className="text-3xl ml-3 text-gray-900 cursor-pointer" />
              </Link>
              <Link href="https://instagram.com">
                <RxInstagramLogo className="text-3xl ml-3 text-gray-900 cursor-pointer" />
              </Link>
              <Link href="https://linkedin.com">
                <FaLinkedin className="text-3xl ml-3 text-gray-900 cursor-pointer" />
              </Link>
              <Link href="https://github.com">
                <FaGithub className="text-3xl ml-3 text-gray-900 cursor-pointer" />
              </Link>
            </div>
          </div>
        </div>
