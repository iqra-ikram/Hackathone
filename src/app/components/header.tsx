    ...
    return (
      <div className="flex flex-col md:flex-row w-full md:w-[1170px] mt-[30px] px-4 md:px-16 items-center max-w-screen-xl mx-auto">
        ...
        <ul className="flex flex-col md:flex-row w-full md:w-auto justify-center md:justify-between gap-4 md:gap-[48px] text-[#000000]">
          <li>
            <Link href="/" className=" text-black font-normal text-[16px] hover:text-[#FB2E86]  text-center md:text-left">
              Home
            </Link>
          </li>
          <li>
            <Link href="/pages" className="font-poppins text-[16px]  hover:text-[#FB2E86] text-center md:text-left">
              Pages
            </Link>
          </li>
          <li>
            <Link href="/product" className="font-poppins text-[16px] hover:text-[#FB2E86] text-center md:text-left">
              Product
            </Link>
          </li>
          <li>
            <Link href="/blog" className="font-poppins text-[16px] hover:text-[#FB2E86] text-center md:text-left">
              Blog
            </Link>
          </li>
          <li>
            <Link href="/shop" className="font-poppins text-[16px] hover:text-[#FB2E86] text-center md:text-left">
              Shop
            </Link>
          </li>
          <li>
            <Link href="/contact" className="font-poppins text-[16px] hover:text-[#FB2E86] text-center md:text-left">
              Contact
            </Link>
          </li>
        </ul>
